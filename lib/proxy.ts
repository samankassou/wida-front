...
const dataPath = /^(?:admin\/(?:metrics|users(?:\/[a-f0-9-]+\/trial)?)|trial(?:\/(?:credits|challenge))?|documents(?:\/workspace(?:\/page|\/[a-f0-9-]+)?|\/[a-f0-9-]+(?:\/content)?)?|invoices(?:\/[a-f0-9-]+|\/document\/[a-f0-9-]+)?|processing(?:\/[a-f0-9-]+|\/documents\/[a-f0-9-]+(?:\/invoice)?)?)$/i;
